    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div>
            ...
            <div>
                <div class="form-group mt-3">
                    <label class="pb-2" for="khoaSV">Khoa</label>
                    <select name="khoaSV" class="form-select" aria-label="Default select example">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Xóa sinh viên</button>
